...
A workflow will begin automaticaly when `ee_builder.yml` has been updated and a PR has been merged to the `dev` branch. 
...
NOTE: These secrets get passed during the GitHub Actions workflow.
  This method is easy for demo but maynot meet production requirements link:https://github.com/r3dact3d/fluffy-ee/blob/main/.github/workflows/ee-builder-dev.yml#L29["Passing Secrets"]

.GitHub Environment Variables
* Update https://github.com/r3dact3d/Ansible-Execution-Environment-Stream/settings/environments[GitHub Environment Variables]
** EE_REGISTRY - Container Image Registry to push execution environment
** EE_REGISTRY_USERNAME - DockerHub or Image Registry Username (needs to provide creds for `EE_REGISTRY`)

NOTE: These variables get passed during the GitHub Actions workflow.
  This method is easy for demo but may not meet production requirements link:https://github.com/r3dact3d/fluffy-ee/blob/main/.github/workflows/ee-builder-dev.yml#L29["Passing Variables"]
